...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_PLAY_MODE] = "images\\Menu_SWITCH_TO_PLAY_MODE.jpg";

	///TODO: Change the path of the images as needed
	MenuItemImages[ITM_SET_FLAG_CELL] = "images\\Menu_Flag.jpg";
	MenuItemImages[ITM_ADD_WORKSHOP] = "images\\Menu_Workshop.jpg";
	MenuItemImages[ITM_ADD_ANTENNA] = "images\\Menu_Antenna.jpg";
	MenuItemImages[ITM_ADD_BELT] = "images\\Menu_Belt.jpg";
	MenuItemImages[ITM_ADD_WATER_PIT] = "images\\Menu_WaterPit.jpg";
	MenuItemImages[ITM_ADD_DANGER_ZONE] = "images\\Menu_DangerZone.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_DESIGN_MODE] = "images\\Menu_SWITCH_TO_DESIGN_MODE.jpg";

	///TODO: Change the path of the images as needed
	MenuItemImages[ITM_EXECUTE_COMMANDS] = "images\\Menu_ExecuteCommands.jpg";
	MenuItemImages[ITM_SELECT_COMMAND] = "images\\select_command_blank.jpg";
	MenuItemImages[ITM_REBOOT_REPAIR] = "images\\Menu_RebootRepair.jpg";
	MenuItemImages[ITM_NEW_GAME] = "images\\Menu_NewGame.jpg";
	MenuItemImages[ITM_EXIT_PLAY] = "images\\Menu_EXIT_PLAY.jpg";
...
void Output::CreateCommandsBar(Command savedCommands[], int savedCommandsCount, Command availableCommands[], int availableCommandsCount) const
{
	...
	CommandItemImages[NO_COMMAND] = "images\\Menu_NO_COMMAND.jpg";
	CommandItemImages[MOVE_FORWARD_ONE_STEP] = "images\\MoveForwardOneStep.jpg";
	CommandItemImages[MOVE_BACKWARD_ONE_STEP] = "images\\Menu_MoveBackwardOneStep.jpg";
	CommandItemImages[MOVE_FORWARD_TWO_STEPS] = "images\\MoveForwardTwoSteps.jpg";
	CommandItemImages[MOVE_BACKWARD_TWO_STEPS] = "images\\Menu_MoveBackwardTwoSteps.jpg";
	CommandItemImages[MOVE_FORWARD_THREE_STEPS] = "images\\MoveForwardThreeSteps.jpg";
	CommandItemImages[MOVE_BACKWARD_THREE_STEPS] = "images\\Menu_MoveBackwardThreeSteps.jpg";
	CommandItemImages[ROTATE_CLOCKWISE] = "images\\Menu_RotateClockwise.jpg";
	CommandItemImages[ROTATE_COUNTERCLOCKWISE] = "images\\RotateCounterClockwise.jpg";
...
// TODO: Draw the player triangle in center(x,y) and filled with the playerColor passed to the function
	DrawTriangle(x, y, 2 * radius, 2 * radius, direction, playerColor, FILLED);
}
...
void Output::DrawBelt(const CellPosition& fromCellPos, const CellPosition& toCellPos) const
{
	...
	if (toCellPos.HCell() > fromCellPos.HCell())
		dir = RIGHT;
	else if (toCellPos.HCell() < fromCellPos.HCell())
		dir = LEFT;
	else if (toCellPos.VCell() > fromCellPos.VCell())
		dir = DOWN;
	else
		dir = UP;
	...
	DrawTriangle(midX, midY, triangleHeight, triangleWidth, dir, UI.BeltColor, FILLED);
...
void Output::DrawFlag(const CellPosition& cellPos) const
{
	...
	DrawTriangle(triangleCenterX, triangleCenterY,
		UI.FlagHeight, UI.FlagWidth,
		RIGHT, UI.FlagColor, FILLED);
...
void Output::DrawRotatingGear(const CellPosition& cellPos, bool clockwise) const
{
	...
	string image;
	if (clockwise)
		image = "images\\Menu_SwitchToGame.jpg";
	else
		image = "images\\Menu_SwitchToGrid.jpg";

	DrawImageInCell(cellPos, image, UI.CellWidth / 2, UI.CellHeight / 2);
...
void Output::DrawAntenna(const CellPosition& cellPos) const
{
	...
	DrawImageInCell(cellPos, "images\\Menu_Antenna.jpg", UI.CellWidth / 2, UI.CellHeight / 2);  ///
